...
document.write("<label>Pays</label><br>");

document.write("<select>");

for (i=0; i<tabPays.length; i++){

   document.write("<option value="+tabCapitale[i]+" >"+tabPays[i]+"</option>");
...
document.write("<label class=\"label\">Capitale</label><br>");
document.write("<select>");
...
for(pays in liste){
   ...
   document.write("<option value=\""+ pays+"\">"+liste[pays]+"</option>");
